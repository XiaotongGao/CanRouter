...
//						<1=>	Divider value is 1 (The source clock is divided by 1 -> PLL output is 48 MHz)
//						<2=>	Divider value is 2 (The source clock is divided by 2 -> PLL output is 96 MHz)
//						<3=>	Divider value is 3 (The source clock is divided by 3 -> PLL output is 144 MHz)
//
...
//			<o12.16>	PCSPIFI: SPI Flash Interface power/clock enable (bit 16)
...
//	</e>
*/
#define QUARTZ					 24000000
#define CLOCK_SETUP         97
#define SCS_Val             0x00000031
#define CLKSRCSEL_Val       0x00000001
#define PLL0_SETUP          68
#define PLL0CFG_Val         0x00000004
#define PLL1_SETUP          0
...
#define SPIFICLKSEL_Val     0x00000103
#define PCONP_Val           0x07F9AE9E
...
#if (CHECK_RSVD((PCONP_Val), ~0xFFFFFFFF))
...
// proto added by PEAK-System to prevent warning
void fpu_init(void);
